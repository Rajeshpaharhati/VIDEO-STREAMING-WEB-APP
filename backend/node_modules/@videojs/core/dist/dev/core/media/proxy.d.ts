import { AnyConstructor, Constructor } from "@videojs/utils/types";

//#region src/core/media/proxy.d.ts
/**
 ...
 */
declare const ProxyMixin: <T extends EventTarget>(PrimaryClass: AnyConstructor<T>, ...AdditionalClasses: AnyConstructor<EventTarget>[]) => Constructor<T>;
//#endregion
export { ProxyMixin };
