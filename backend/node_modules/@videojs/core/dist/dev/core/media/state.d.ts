//#region src/core/media/state.d.ts
 ...
 */
interface MediaTextTrack<Kind extends TextTrackKind> {
  kind: Kind;
  label: string;
  language: string;
  mode: TextTrackMode;
...
//#endregion
export { MediaBufferState, MediaControlsState, MediaError, MediaErrorState, MediaFeatureAvailability, MediaFullscreenState, MediaPictureInPictureState, MediaPlaybackRateState, MediaPlaybackState, MediaSourceState, MediaTextCue, MediaTextTrack, MediaTextTrackState, MediaTimeState, MediaVolumeState, TextTrackKind, TextTrackMode };
