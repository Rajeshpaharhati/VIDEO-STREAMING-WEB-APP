 ...
 */
declare function getPositioningCSSVars(triggerRect: DOMRect, boundaryRect: DOMRect, side: PopoverSide, cssVars?: PositioningCSSVars): Record<string, string>;
 ...
 */
declare function getManualPositionStyle(triggerRect: DOMRect, popupRect: DOMRect, opts: PositioningOptions, offsets?: ManualOffsets): {
  top: string;
  left: string;
};
/**
 ...
 */
declare function getPopupPositionRect(el: HTMLElement): DOMRect;
//#endregion
export { ManualOffsets, PopoverPositionStyle, PositioningCSSVars, PositioningOptions, getAnchorNameStyle, getAnchorPositionStyle, getManualPositionStyle, getPopoverCSSVars, getPopupPositionRect, getPositioningCSSVars, resolveOffsets };
