//#region src/dom/media/custom-media-element/index.d.ts
/**
...
type EventsMap = { [key in (typeof Events)[number]]: CustomEvent };
declare const Attributes: readonly ["autopictureinpicture", "disablepictureinpicture", "disableremoteplayback", "autoplay", "controls", "controlslist", "crossorigin", "loop", "muted", "playsinline", "poster", "preload", "src"];
/**
 ...
 */
declare function CustomMediaMixin<T extends Constructor<HTMLElement>>(superclass: T, {
  tag,
  is
}: {
  tag: 'video';
...
declare const CustomVideoElement: CustomVideoElement;
declare const CustomAudioElement: CustomAudioElement;
//#endregion
export { Attributes, CustomAudioElement, CustomMediaMixin, CustomVideoElement, Events, EventsMap };
